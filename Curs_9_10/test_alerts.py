...
# scenariu testare negativa testare negativa = testarea situatiilor nefavorabile pe care sistemul ar trebui sa nu le
    # poata executa, dar sa le trateze corect
